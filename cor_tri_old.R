...
setwd("F:/ICD/cor_tri_old")

library(ggplotify)

tumor_list = c('ACC', 'BRCA', 'BLCA', 'CESC', 'COAD', 'CHOL', 'ESCA', 'GBM', 'HNSC', 'KIRP', 'KIRC',  'LGG', 'LUAD', 'LUSC', 'LIHC', 'LAML', 'OV', 'PRAD', 'PAAD', 'PCPG', 'READ', 'STAD', 'SKCM', 'THCA', 'TGCT', 'UCEC', 'UCS')
